        ...
        <aside class="w-64 bg-gray-100 text-gray-900 shadow-xl flex flex-col justify-between">
            <div class="p-6">
                ...
                <nav class="space-y-3 text-sm font-semibold">
                    <a href="{{route("mahasiswa.dashboard")}}" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-red-200 @if(request()->is('dashboard')) bg-red-800 text-white @endif">
                        🏠 Dashboard
                    </a>
                    ...
                    <a href="{{route("khs.nilaiMahasiswa")}}" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-red-200 @if(request()->is('khs*')) bg-red-800 text-white @endif">
                        🧾 KHS
                    </a>
                    <a href="{{route("profile.mahasiswa.index")}}" class="flex items-center gap-2 px-4 py-2 rounded hover:bg-red-200 @if(request()->is('profile*')) bg-red-800 text-white @endif">
                        🔐 Profile
                    </a>
                </nav>
            </div>
