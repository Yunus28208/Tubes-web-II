        ...
        <aside class="w-80 sidebar-glass relative overflow-hidden">
            ...
            <div class="relative z-10 h-full flex flex-col p-6">
                ...
                <nav class="flex-1 space-y-4">
                    ...
                    <!-- KRS -->
                    <a href="{{ route('krs.mahasiswa.index') }}" class="menu-item {{ request()->is('krs*') ? 'active' : '' }} flex items-center gap-4 p-4 rounded-xl text-white transition-all duration-300">
                        <div class="menu-icon w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- KHS -->
                    <a href="{{ route('khs.nilaiMahasiswa') }}" class="menu-item {{ request()->is('khs*') ? 'active' : '' }} flex items-center gap-4 p-4 rounded-xl text-white transition-all duration-300">
                        <div class="menu-icon w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Profile -->
                    <a href="{{ route('profile.mahasiswa.index') }}" class="menu-item {{ request()->is('profile*') ? 'active' : '' }} flex items-center gap-4 p-4 rounded-xl text-white transition-all duration-300">
                        <div class="menu-icon w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
