...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 text-white">
    ...
    <div class="layout-container">
        ...
        <!-- Elegant Sidebar -->
        <aside class="sidebar-container glass-effect shadow-2xl border-r border-white/10" id="sidebar">
            <div class="sidebar-content">
                ...
                <div class="p-6 lg:p-8 flex-shrink-0">
                    ...
                    <div class="text-center mb-8 lg:mb-12">
                        ...
                        <div class="w-12 lg:w-16 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-500 mx-auto mt-3"></div>
                    </div>
                    
                    <!-- Navigation -->
                    <nav class="space-y-1 lg:space-y-2">
                        <a href="{{route('admin.dashboard')}}" class="sidebar-item flex items-center gap-3 lg:gap-4 px-3 lg:px-4 py-2.5 lg:py-3 rounded-xl text-gray-300 hover:text-white hover:bg-white/5 @if(request()->is('dashboard')) active-item text-white @endif group">
                ...
                <div class="p-4 lg:p-6 border-t border-white/10 flex-shrink-0">
                    ...
                    <div class="p-3 lg:p-4 rounded-xl glass-effect">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center flex-shrink-0">
        ...
        <main class="main-container">
            <!-- Top Header -->
            <header class="main-header glass-effect border-b border-white/10 p-4 lg:p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex-1 min-w-0">
                        <h2 class="text-xl lg:text-2xl font-bold text-white truncate">@yield('page-title', 'Dashboard')</h2>
                        <p class="text-gray-400 mt-1 text-sm lg:text-base truncate">@yield('page-description', 'Selamat datang di Sistem Informasi Akademik')</p>
                    </div>
