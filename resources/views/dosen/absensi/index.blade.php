...
<div class="min-h-screen p-8">
    ...
    <div class="glass-effect rounded-2xl p-8 luxury-shadow border border-gold-500/20">
        <!-- Table Header -->
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gold-300 mb-2">Daftar Kelas</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-slate-700/70">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-medium text-gold-300 uppercase tracking-wider">
                            ...
                            <th class="px-6 py-4 text-center text-xs font-medium text-gold-300 uppercase tracking-wider">
                    ...
                    <tbody class="divide-y divide-slate-600/50">
                        ...
                        <tr class="hover:bg-slate-700/30 transition-all duration-300 group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="w-8 h-8 bg-gradient-to-br from-gold-400 to-gold-600 rounded-full flex items-center justify-center text-white text-sm font-bold luxury-shadow">
                                    {{ $loop->iteration }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                ...
                                <div class="flex items-center justify-center gap-3">
                                    <a href="{{ route('dosen.absensi.create', ['kelas_id' => $a->jadwal->kelas->id]) }}" 
                                       class="group/btn inline-flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105 luxury-shadow">
                                    ...
                                    <a href="{{ route('dosen.absensi.edit', ['kelas_id' => $a->jadwal->kelas->id]) }}" 
                                       class="group/btn inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105 luxury-shadow">
                                        <svg class="w-4 h-4 group-hover/btn:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
