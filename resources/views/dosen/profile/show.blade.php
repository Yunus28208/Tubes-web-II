...
<div class="min-h-screen p-8">
    ...
    <div class="relative">
        ...
        <!-- Status Indicator -->
        <div
            class="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-slate-800 flex items-center justify-center">
    ...
    <div class="flex-1 text-center md:text-left">
        ...
        <!-- Role Badge -->
        <div
            class="inline-flex items-center gap-2 bg-gradient-to-r from-gold-500/20 to-gold-600/20 border border-gold-500/30 rounded-full px-4 py-2 mb-4">
        ...
        <!-- Button Edit Akun (di bawah pada mobile, kanan di desktop) -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-slate-800/50 rounded-xl p-6 border border-slate-700/50 hover:border-gold-500/30 transition-all duration-300">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h3 class="text-gold-300 font-semibold">Email</h3>
                        </div>
                    </div>
                    <div class="bg-slate-700/50 rounded-lg p-4 border border-slate-600/50">
