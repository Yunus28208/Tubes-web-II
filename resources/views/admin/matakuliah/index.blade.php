...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-xl p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-white mb-2">Data Mata Kuliah</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $mata_kuliah->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $mata_kuliah->where('semester', 'ganjil')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $mata_kuliah->where('semester', 'genap')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $mata_kuliah->sum('sks') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl overflow-hidden">
        <div class="p-6 border-b border-white/10">
            <h3 class="text-lg font-semibold text-white">Daftar Mata Kuliah</h3>
        </div>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('matakuliah.edit', $mk->id_mata_kuliah) }}" 
                                ...
                                <form action="{{ route('matakuliah.destroy', $mk->id_mata_kuliah) }}" method="POST" onsubmit="return confirm('Yakin hapus mata kuliah ini?')" class="inline">
                                    @csrf 
                                    @method('DELETE')
                                    <button type="submit" 
