...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 md:p-6 lg:p-8 flex items-center justify-center" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="absolute inset-0 opacity-5">
        ...
        <div class="absolute top-1/2 left-1/2 w-32 h-32 bg-blue-500 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="relative z-10 w-full max-w-2xl">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white mb-2">Tambah Jadwal</h1>
            <p class="text-gray-300">Buat jadwal perkuliahan baru</p>
        </div>
        ...
        <div class="glass-card rounded-2xl p-8">
            <form action="{{ route('jadwal.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="hari" placeholder="Hari (contoh: Senin)" class="form-input w-full px-4 py-3 rounded-xl text-white placeholder-gray-400 focus:outline-none" required>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="time" name="jam_mulai" class="form-input w-full px-4 py-3 rounded-xl text-white focus:outline-none" required>
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-300 mb-2">
                            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="time" name="jam_selesai" class="form-input w-full px-4 py-3 rounded-xl text-white focus:outline-none" required>
                    </div>
                </div>
                ...
                <div class="flex gap-4 pt-6">
                    <button type="submit" class="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
