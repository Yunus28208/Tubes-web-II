...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $prodi->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-gray-400 text-sm">Prodi Aktif</p>
                    <p class="text-2xl font-bold text-white">{{ $prodi->count() }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="glass-card rounded-xl overflow-hidden">
        <div class="p-6 border-b border-white/10">
            <h3 class="text-lg font-semibold text-white">Daftar Program Studi</h3>
        </div>
            ...
            <table class="min-w-full">
                <thead class="bg-white/5">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Nama Program Studi</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Fakultas</th>
                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="table-row">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                            <div class="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white font-semibold text-xs">
                                {{ $loop->iteration }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center">
                                    <span class="text-white font-semibold text-sm">{{ substr($prodis->nama, 0, 1) }}</span>
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-white">{{ $prodis->nama }}</div>
                                    <div class="text-sm text-gray-400">Program Studi</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <div>
                                    <p class="text-gray-400 font-medium">Tidak ada data program studi</p>
                                    <p class="text-gray-500 text-sm">Mulai dengan menambahkan program studi baru</p>
                                </div>
                            </div>
                        </td>
                    </tr>
