...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-xl p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-white mb-2">Data Dosen</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $dosen->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $dosen->pluck('bidang_keahlian')->unique()->count() }}</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-white">{{ $d->nama }}</div>
