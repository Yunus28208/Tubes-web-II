...
<div class="min-h-screen w-full bg-slate-900 text-white p-6">
    ...
    <div class="bg-slate-800 rounded-xl p-6 mb-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('krs.create') }}" class="bg-emerald-600 hover:bg-emerald-700 px-4 py-2 rounded-lg text-white font-medium shadow-lg transition-colors duration-200 flex items-center gap-2">
