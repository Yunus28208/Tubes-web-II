...
@section('page-description', 'Tambahkan data fakultas baru ke sistem')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-card rounded-xl p-6 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-white">Tambah Fakultas Baru</h2>
                <p class="text-gray-400">Lengkapi form di bawah untuk menambahkan fakultas</p>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl p-8">
        <form action="{{ route('admin.fakultas.store') }}" method="POST" class="space-y-6">
            @csrf
