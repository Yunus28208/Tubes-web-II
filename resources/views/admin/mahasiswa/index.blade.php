...
<div class="space-y-6">
    ...
    <div class="glass-card rounded-xl p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-white mb-2">Data Mahasiswa</h2>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $mahasiswa->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card rounded-xl p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $prodi }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="glass-card rounded-xl overflow-hidden">
        <div class="p-6 border-b border-white/10">
            <h3 class="text-lg font-semibold text-white">Daftar Mahasiswa</h3>
        </div>
                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="table-row">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                            <div class="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center text-white font-semibold text-xs">
                                {{ $loop->iteration }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-sm font-medium text-white">{{ $mhs->nama }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <form action="{{ route('mahasiswa.destroy', $mhs->id_mahasiswa) }}" method="POST" onsubmit="return confirm('Yakin hapus data mahasiswa ini?')" class="inline">
                                    @csrf 
                                    @method('DELETE')
                                    <button type="submit" 
