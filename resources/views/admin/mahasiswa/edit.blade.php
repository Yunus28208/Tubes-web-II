...
<div class="max-w-4xl mx-auto">
    ...
    <div class="glass-card rounded-xl p-6 mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-white">Edit Data Mahasiswa</h2>
                <p class="text-gray-400">Perbarui informasi mahasiswa: <span class="text-emerald-400 font-medium">{{ $mahasiswa->nama }}</span></p>
            </div>
        </div>
    </div>
