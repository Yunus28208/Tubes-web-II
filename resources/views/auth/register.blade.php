...
<head>
    ...
    <style>
        ...
        .premium-button:hover {
            ...
            background: linear-gradient(135deg, #34d399, #10b981, #06d6a0);
        }
...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-x-hidden">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-cyan-400/20 to-blue-600/20 rounded-full blur-3xl"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-teal-400/10 to-emerald-600/10 rounded-full blur-3xl"></div>
    </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div class="text-center lg:text-left relative">
                                ...
                                <div class="floating-logo mb-8">
                                    <div class="relative inline-block mb-6">
                                        <div class="absolute inset-0 bg-emerald-400 rounded-full pulse-ring"></div>
                                        <div class="luxury-border inline-block">
                                    ...
                                    <p class="text-gray-300 text-lg font-light mb-8">
                                        ...
                                        <span class="text-emerald-400 font-medium">Academic Excellence</span>
                                    </p>
                                </div>
                            ...
                            <div class="w-full">
                                <div class="mb-8">
                                    ...
                                    <p class="text-gray-300">Join our academic community today</p>
                                    <div class="w-16 h-1 bg-gradient-to-r from-emerald-400 to-blue-500 mt-4 rounded-full"></div>
                                </div>
                                ...
                                <form action="{{ route('auth.register') }}" method="POST" class="space-y-6">
                                    ...
                                    <button type="submit" class="premium-button w-full py-4 text-white font-bold text-lg rounded-xl transition-all duration-300 flex items-center justify-center gap-2">
                                ...
                                <div class="mt-8 text-center">
                                    <p class="text-gray-300">
                                        ...
                                        <a href="{{ route('auth.login') }}" class="text-emerald-400 hover:text-emerald-300 font-semibold underline transition-colors">
                                            Sign In Here
                                        </a>
                                    </p>
                                </div>
